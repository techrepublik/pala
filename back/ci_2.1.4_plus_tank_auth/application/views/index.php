...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('_/css/jquery-ui.min.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('_/css/bootstrap.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('_/css/font-awesome.min.csss'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('_/css/custom.css'); ?>">
